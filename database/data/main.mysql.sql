...
`location_y` int(11) NOT NULL,
  ...
  CONSTRAINT `component_parent_component_id` FOREIGN KEY (`parent_component_id`) REFERENCES `ct_component` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CONSTRAINT `component_template_type_id` FOREIGN KEY (`template_type_id`) REFERENCES `ct_level` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `component_level_id` FOREIGN KEY (`level_id`) REFERENCES `ct_level` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
